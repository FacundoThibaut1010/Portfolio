      ...
      <div className="max-w-[85rem] mx-auto w-full">
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 relative">
            ...
            <motion.div variants={itemVariants} className="lg:col-span-5 bg-[#1a1b26]/95 border border-gray-800 rounded-2xl p-8 md:p-10 relative overflow-hidden shadow-2xl flex flex-col items-center">
              {/* Glow background */}
              ...
              <div className="relative w-56 h-56 mx-auto mb-10 flex flex-col justify-center items-center">
                {/* Decorative arcs */}
                ...
                <div className="w-40 h-40 rounded-full border border-gray-700 bg-[#16161a] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-0 overflow-hidden flex items-center justify-center p-1.5">
              ...
              <div className="space-y-4 text-sm font-mono w-full mt-auto">
                <div className="flex justify-between items-center border-b border-gray-800/80 pb-4">
                  <span className="text-gray-500 uppercase tracking-widest text-[11px]">{t.about_operator}</span>
                  <span className="text-orange-500 font-bold tracking-widest text-sm">FACUNDO THIBAUT</span>
                </div>
                <div className="flex justify-between items-center border-b border-gray-800/80 py-4">
                  <span className="text-gray-500 uppercase tracking-widest text-[11px]">{t.about_role}</span>
                  <span className="text-[#61afef] font-medium tracking-wide text-xs">FULL_STACK_SOFTWARE_ENGINEER</span>
                </div>
                <div className="flex justify-between items-center border-b border-gray-800/80 py-4">
                  <span className="text-gray-500 uppercase tracking-widest text-[11px]">{t.about_location}</span>
                  <span className="text-gray-300 font-medium text-sm">{t.about_location_val}</span>
                </div>
                <div className="flex justify-between items-center pt-4">
                  <span className="text-gray-500 uppercase tracking-widest text-[11px]">{t.about_status}</span>
                  <span className="text-emerald-400 bg-emerald-950/50 border border-emerald-500/20 px-3 py-1 rounded text-xs tracking-widest font-bold shadow-[0_0_10px_rgba(16,185,129,0.1)]">{t.about_status_val}</span>
                </div>
              </div>
            </motion.div>
            ...
            <div className="lg:col-span-7 flex flex-col gap-6 h-full">
              ...
              <motion.div variants={itemVariants} className="bg-[#1a1b26] border border-gray-800 rounded-2xl p-8 md:p-10 shadow-2xl flex-grow h-full">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                {[
                  ...
                  <motion.div variants={itemVariants} key={i} className="bg-[#1a1b26] border border-gray-800 rounded-2xl p-6 flex flex-col gap-3 relative overflow-hidden group hover:border-gray-600 transition-colors">
